The canonical system Equation (\ref{eq: canonical}) is extended to three dimensions by considering $\epsilon'=0$, 
...
\textbf{+++Undo transformation, explain $r$ and $\epsilon$ coordinates in prop. ThenDONE!+++}
\end{proof}
...
The full result is visualised in Figure \ref{fig: full solution fold}.
%\begin{figure}[h!]\centering
