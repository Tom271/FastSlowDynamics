...
These two systems will be used throughout the following analysis of the generic fold point. We should note that we have used the general system (Equations \ref{eq: general system}) to produce the new system where we have chosen $ \lambda=1 $.\\
