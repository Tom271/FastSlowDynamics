...
\subsection{Global Solution}\label{sec:effect-of-the-canard-point}
...
\begin{prop}
	...
	\begin{subequations}
		\begin{align}
		d_{r_2}&=\int_{-\infty}^{\infty}(\nabla H(\gamma_{c,2}(t)))^T\cdot G(\gamma_{c,2}(t))\dif t,\\
		d_{\lambda_2}&=\int_{-\infty}^{\infty}(\nabla H(\gamma_{c,2}(t)))^T\cdot (0,-1)^T \dif t,
		\end{align}
	\end{subequations}
