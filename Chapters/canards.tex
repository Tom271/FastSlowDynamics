...
\subsection{Effect of the Canard Point}
Now that we have shown that there must exist a flow around our fold point we should now consider the global effect of the canard point. We can see by considering the linearised system of Equations \ref{canard: system of equations} that,
\begin{equation}
\det(A-\lambda I)=\begin{bmatrix}
stuff
\end{bmatrix},
\end{equation}
with our equilibriums at $ (x,y)=(\lambda,\lambda[\frac{\lambda^2}{3}-1]) $ and eigenvalues.

%Now that we have defined our charts we can see how the flow will interact with new equilibrium point, due to the canard. To do this we consider the eigenvalues of our system 
