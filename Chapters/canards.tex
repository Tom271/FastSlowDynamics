...
\end{figure}
During this section we will be considering a canard point. This is when our fold point is shifted along the manifold - Figure \ref{fig: Canard Point}. To adequately explain the effect that the canard point will have on our system we will first define the following conditions,
\begin{equation}
