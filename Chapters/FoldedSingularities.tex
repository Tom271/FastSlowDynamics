...
\begin{theorem}[\textbf{Canards in $ \mathbf{R}^3$} \citep{MMO}]\label{thm: canards in R3}
...
\begin{figure}[h!]
	...
	\begin{subfigure}[t]{0.45\textwidth}
		\centering
			\includegraphics[height=10cm,width=10cm]{MMO-spirals}
		\caption{Folded Node Region for $\mu \approx0.0557$.}
		\label{fig: MMo1pic}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.45\textwidth}
			\includegraphics[width=\textwidth]{MMO2}
