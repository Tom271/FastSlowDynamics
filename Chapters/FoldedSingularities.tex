...
As a result we are able to write these flows in the following manner, \textbf{using Equations \ref{eq: fs singularity system}, \ref{eq: non-degeneracy 3d system} and noting that $ \pd{f}{t}=0=\pd{f}{x} $,  }
\begin{equation}
