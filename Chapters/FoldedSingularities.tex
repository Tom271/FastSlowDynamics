...
\end{bmatrix},
\end{equation}
+++++++++++++++Note: either 5x5 matrix J with two last rows zero. however then in the system above need $\lambda' =0, \epsilon'=0$. if not, then delete the last two columns in J and make it 3x3++++++++++++++++++++++++++++++++++++++++++++++   
